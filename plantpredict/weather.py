...
class Weather(PlantPredictEntity):
    ...
    def create(self):
        ...
        .. csv-table:: Minimum required attributes for successful Weather creation
            ...
            weather_detail; list of dict; The code block below contains an example of one timestamp (array element) of this field, as well as information on which dictionary keys are required.
